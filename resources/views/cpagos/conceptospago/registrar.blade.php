...
@section('titulo','Listado de Conceptos de Pago')
                            ...
                            <div class="col-md-6 d-flex justify-content-md-end justify-content-start">
                                <form id="formBuscar" method="GET" class="w-100" style="max-width: 100%;">
                                    <div class="input-group">
                                        <input id="inputBuscar" name="buscarpor" class="form-control mt-3" type="search" placeholder="Buscar Nombre" aria-label="Search" value="{{ $buscarpor }}" autocomplete="off">
                            ...
                            <table id="add-row" class="table-hover table" style="border: 1px solid #0A8CB3; border-radius: 10px; overflow: hidden;">
                                ...
                                <tbody>
                                    @foreach($conceptos as $item)
                                        <tr>
                                            <td class="text-center">{{ $item->concepto_id }}</td>
