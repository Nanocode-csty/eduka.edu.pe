...
@section('titulo','Registrar Niveles Educativos')
...
<div class="container">     
    ...
    <div class="fw-bold border-bottom mb-4 animate-slide-in">
        <h2>Listado de niveles educativos registrados.</h2>
    </div>
    ...
    <table id="add-row" class="display table table-striped table-hover" >
        ...
        <tbody>
                @foreach($niveles as $itemNivel)                                            
                    <tr>                                         
                        <td class="text-center">{{ $itemNivel->nivel_id }}</td>
                        <td>{{ $itemNivel->nombre }}</td>
                        <td>{{ $itemNivel->descripcion }}</td>                                                
                    </tr>                  
                @endforeach         
