...
@section('titulo','Registrar Grados')
...
<div class="container">     
    ...
    <div class="fw-bold border-bottom mb-4 animate-slide-in">
        <h2>Listado de grados registrados.</h2>
    </div>
    ...
    <table id="add-row" class="display table table-striped table-hover" >
        ...
        <tbody>
                @foreach($grados as $itemGrado)                                            
                    <tr>                                         
                        <td class="text-center">{{ $itemGrado->grado_id }}</td>
                        <td>{{ $itemGrado->nivel_nombre }}</td>
                        <td>{{ $itemGrado->nombre }}</td>
                        <td>{{ $itemGrado->descripcion }}</td>                                                
                    </tr>                  
                @endforeach         
