...
<div id="{{ $id ?? 'loaderAnimado' }}" style="display: none; position: absolute; z-index: 1000; top: 0; left: 0; right: 0; bottom: 0; justify-content: center; align-items: center; background: rgba(255,255,255,0.8);">
